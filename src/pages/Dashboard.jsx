    ...
    <div className="content">
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p>Here's what needs your attention today — Monday, April 28, 2025</p>
        </div>
      ...
      <div className="quick-grid">
        <div className="quick-card">
          ...
          <div className="quick-text">
            <div className="qt-title">Start onboarding</div>
            <div className="qt-sub">Create a new hire record</div>
          </div>
        </div>
        ...
        <div className="quick-card">
          ...
          <div className="quick-text">
            <div className="qt-title">Start offboarding</div>
            <div className="qt-sub">Initiate employee exit checklist</div>
          </div>
        </div>
        ...
        <div className="quick-card">
          ...
          <div className="quick-text">
            <div className="qt-title">Review access requests</div>
            <div className="qt-sub">3 requests awaiting approval</div>
          </div>
        </div>
        ...
        <div className="quick-card">
          ...
          <div className="quick-text">
            <div className="qt-title">Generate report</div>
            <div className="qt-sub">Export activity summary</div>
          </div>
        </div>
      </div>
        ...
        <div className="card">
          ...
          <div className="table-wrap">
            <table>
              <thead>
                <tr>
                  <th><span className="checkbox"></span></th>
                  <th>Employee</th>
                  <th>Task</th>
                  <th>Type</th>
                  <th>Due</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div className="av-pill">
                      ...
                      <div>
                        <span className="td-primary">R. Chen</span>
                        <span className="td-sub">Engineering · EMP-00461</span>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div className="av-pill">
                      ...
                      <div>
                        <span className="td-primary">M. Alvarez</span>
                        <span className="td-sub">Marketing · EMP-00482</span>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div className="av-pill">
                      ...
                      <div>
                        <span className="td-primary">S. Patel</span>
                        <span className="td-sub">Finance · EMP-00451</span>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div className="av-pill">
                      ...
                      <div>
                        <span className="td-primary">T. Nguyen</span>
                        <span className="td-sub">Sales · EMP-00479</span>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div className="av-pill">
                      <div className="av green">KB</div>
                      <div>
                        <span className="td-primary">K. Brooks</span>
                        <span className="td-sub">HR · EMP-00483</span>
                      </div>
                    </div>
                  </td>
          ...
          <div className="pagination">
            ...
            <div className="pag-pages">
              <div className="pag-btn">‹</div>
              <div className="pag-btn active">1</div>
              <div className="pag-btn">2</div>
              <div className="pag-btn">3</div>
              <div className="pag-btn">›</div>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-header">
            <div className="card-header-left">
              ...
              <div className="card-sub">System and user actions</div>
            </div>
          </div>
          ...
          <div className="feed">
            <div className="feed-item">
              ...
              <div className="feed-body">
                <div className="feed-title">Account provisioned for <span>D. Walsh</span> (Engineering)</div>
                <div className="feed-meta">12 min ago · J. Diaz</div>
              </div>
            </div>
            ...
            <div className="feed-item">
              ...
              <div className="feed-body">
                <div className="feed-title">Access request denied — elevated DB access for <span>T. Nguyen</span></div>
                <div className="feed-meta">1 hr ago · M. Reyes (Manager)</div>
              </div>
            </div>
            ...
            <div className="feed-item">
              ...
              <div className="feed-body">
                <div className="feed-title">Laptop #LP-2291 assigned to <span>M. Alvarez</span></div>
                <div className="feed-meta">2 hrs ago · IT Inventory (auto)</div>
              </div>
            </div>
            ...
            <div className="feed-item">
              ...
              <div className="feed-body">
                <div className="feed-title">Temp access for <span>S. Patel</span> expiring in 3 days</div>
                <div className="feed-meta">4 hrs ago · System reminder</div>
              </div>
            </div>
            ...
            <div className="feed-item">
              <div className="feed-dot green">✓</div>
              <div className="feed-body">
                <div className="feed-title">Offboarding completed for <span>A. Romero</span> — all access revoked</div>
                <div className="feed-meta">Yesterday · System automated</div>
              </div>
            </div>
            ...
            <div className="feed-item">
              <div className="feed-dot blue">+</div>
              <div className="feed-body">
                <div className="feed-title">Onboarding started for <span>K. Brooks</span> — HR department</div>
                <div className="feed-meta">Yesterday · S. Lopez (HR)</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="card full-card">
        <div className="card-header">
          <div className="card-header-left">
            <div className="card-title">Department access templates</div>
            <div className="card-sub">Active provisioning templates and assigned employee counts</div>
          </div>
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              <tr>
                <td><span className="td-primary">Engineering</span></td>
                <td><span className="td-normal">ENG — Standard Access</span></td>
                <td>
              ...
              <tr>
                <td><span className="td-primary">Marketing</span></td>
                <td><span className="td-normal">MKT — Standard Access</span></td>
                <td>
              ...
              <tr>
                <td><span className="td-primary">Finance</span></td>
                <td><span className="td-normal">FIN — Restricted Access</span></td>
                <td>
              ...
              <tr>
                <td><span className="td-primary">Sales</span></td>
                <td><span className="td-normal">SLS — Standard Access</span></td>
                <td>
                ...
                <td>56</td>
                <td>Jan 19, 2025</td>
                <td><span className="badge badge-amber">Review needed</span></td>
              </tr>
            </tbody>
          </table>
        </div>
